    ...
    <div class="content-table">
        <table>
            <c:if test="${limit==true}">
                <p style="color:red;font-size:20px;padding-top: 10px;text-align: center">Bạn chỉ được thêm tối đa 5
                    thành viên</p>
            </c:if>
            <caption><h2 style="padding-bottom: 20px">List of Users</h2></caption>
            <tr>
                <th>Id</th>
                <th>Name</th>
                <th>Phone</th>
            ...
            <c:forEach var="user" items="${listUser}">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/users?action=view&id=${user.id}">Detail</a>
        ...
        <div class="add-back" style="text-align: center; padding-top: 20px;">
            <a href="${pageContext.request.contextPath}/users?action=add">Add</a>
