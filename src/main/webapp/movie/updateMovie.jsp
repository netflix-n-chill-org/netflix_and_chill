...
<form method="post" action="${pageContext.request.contextPath}/movie?action=update">
    ...
    <c:if test="${updateMessage==true}">
        <p style="font-size: 20px;color:red;text-align: center">Cập nhật thành công</p>
    </c:if>
</form>
...
<script>
    ...
    function redirectToUpdateMovie(movieId) {
        ...
        window.location.href = "../movie?action=list" + movieId;
    }
