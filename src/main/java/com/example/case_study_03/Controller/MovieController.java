    ...
    private void addMovie(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (movieRepository != null) {
                ...
                if (movieRepository.addMovie(newMovie)) {
//                    response.sendRedirect("/movie");
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(request.getParameter("id"));
        Movie existingMovie = movieRepository.selectMovie(id);
    ...
    private void deleteMovie(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Movie> movieList = movieRepository.selectAllMovie();
        request.setAttribute("movieList", movieList);
        RequestDispatcher dispatcher = request.getRequestDispatcher("/movie/deleteMovie.jsp");
        dispatcher.forward(request, response);
    ...
    private void listMovie(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, SQLException, IOException {
        List<Movie> movieList = movieRepository.showAllMovies();
        request.setAttribute("movieList", movieList);
